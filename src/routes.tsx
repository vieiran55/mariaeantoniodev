...
import PresencasConfirmadas from "./pages/PresencasConfirmadas";
    ...
    <Router>
      <Routes>
        ...
        <Route
          path="/adm"
          element={
            <Adm repositorio={repositorio} setRepositorio={setRepositorio} />
          }
        />
        <Route path="/presenca" element={<Presenca />} />
        <Route path="/login" element={<LoginPage />} />
        <Route  path="/lista" element={<PresencasConfirmadas />} />
      </Routes>
      <Rodape />
    </Router>
  );
